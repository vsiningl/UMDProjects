...
public class Video implements Comparable<Video> {
	...
	public Video(String title, String url, int durationInMinutes, Genre videoGenre) {
		if (title.isBlank() || title.equals(null) || url.isBlank() || url.equals(null) || durationInMinutes <= 0
				|| videoGenre == null) {
	...
	public boolean addComments(String comments) {
		if (comments.isBlank() || comments.equals(null)) {
	...
	public int compareTo(Video video) {
		int comp = this.title.compareTo(video.title);
		return comp;
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof Video) {
			Video thing = (Video) obj;
			if (this.title.equals(thing.title)) {
				return true;
			}
		}
		return false;
